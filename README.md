# <p align="center"><a href="https://userstyles.world/style/498/stylus-modern-dark-theme">Stylus Modern Dark Theme</a></p>
...
<div id="installation">
 <h2>📁 Installation</h2>
   ...
   <div class="user.css">
     <h3>👉 Then 
        <a href="https://github.com/blyad2137/stylus-modern-dark-theme/blob/main/dark-theme.user.css" style="font-size: 2rem;"> install the user.css</a></h3>
   </div>
</div>
